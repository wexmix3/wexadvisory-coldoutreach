...
async function enrichProspect(prospect: {
  ...
  const prompt = `You are analyzing a small business website to personalize a cold email about AI automation services.
...
Reply with valid JSON only — no prose, no markdown:
{
  ...
  "custom_intro": "<1-2 sentences referencing something specific from their site — a service they list, a manual process they describe, or a pain point implied by how their site is structured>",
  "pain_signal": "<5-10 word phrase naming the specific manual process you spotted>"
}
...
custom_intro must reference something specific. Bad: "Most businesses waste hours on manual tasks." Good: "I noticed Peak Pilates still handles class waitlists and member check-ins via email — that's typically 4-6 hours a week most studios reclaim with simple automation."`
